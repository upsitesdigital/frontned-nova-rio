...
export function PasswordChangeDialog() {
  ...
  const newPwdVisible = usePasswordVisibilityStore((s) => s.isVisible("admin-profile-new-pwd"));
  const confirmPwdVisible = usePasswordVisibilityStore((s) =>
    s.isVisible("admin-profile-confirm-pwd"),
  );
        ...
        <div className="flex flex-col gap-4">
          ...
          <DsFormField label="Nova senha">
            <DsPasswordInput
              ...
              onVisibilityChange={(v) => setPwdVisibility("admin-profile-new-pwd", v)}
          ...
          <DsFormField label="Confirmar senha" error={passwordMismatch}>
            <DsPasswordInput
              ...
              onVisibilityChange={(v) => setPwdVisibility("admin-profile-confirm-pwd", v)}
