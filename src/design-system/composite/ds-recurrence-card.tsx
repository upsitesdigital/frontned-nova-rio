...
function DsRecurrenceCard({ title, description, children, className }: DsRecurrenceCardProps) {
  return (
    <div
      className={cn(
        "flex flex-col gap-8 rounded-3xl border border-nova-gray-100 bg-white p-6",
        className,
      )}
    >
      <div className="flex flex-col gap-2 leading-[1.3]">
        ...
        {description && (
          <p className="text-base tracking-[-0.64px] text-nova-gray-700">{description}</p>
        )}
      </div>
