...
import { AdminAppointmentsApi } from "./admin-appointments-api";
...
describe("admin-appointments-api", () => {
  ...
  describe("fetchAdminAppointments", () => {
    it("should call with page and limit params", async () => {
      ...
      await AdminAppointmentsApi.fetchAdminAppointments({ page: 1, limit: 10 });
    ...
    it("should include date param when provided", async () => {
      ...
      await AdminAppointmentsApi.fetchAdminAppointments({ page: 1, limit: 10, date: "2026-03-15" });
    ...
    it("should include employeeId param", async () => {
      ...
      await AdminAppointmentsApi.fetchAdminAppointments({ page: 1, limit: 10, employeeId: 5 });
    ...
    it("should include unitId param", async () => {
      ...
      await AdminAppointmentsApi.fetchAdminAppointments({ page: 1, limit: 10, unitId: 3 });
    ...
    it("should forward AbortSignal", async () => {
      ...
      await AdminAppointmentsApi.fetchAdminAppointments({ page: 1, limit: 10 }, controller.signal);
  ...
  describe("fetchEmployees", () => {
    it("should return raw employee data without filtering", async () => {
      ...
      const result = await AdminAppointmentsApi.fetchEmployees();
    ...
    it("should call /employees endpoint with limit", async () => {
      ...
      await AdminAppointmentsApi.fetchEmployees();

      expect(HttpClient.authGet).toHaveBeenCalledWith("/employees?limit=100");
    });
  });
  ...
  describe("fetchUnits", () => {
    it("should return raw unit data without filtering", async () => {
      ...
      const result = await AdminAppointmentsApi.fetchUnits();
    ...
    it("should call /units endpoint with limit", async () => {
      ...
      await AdminAppointmentsApi.fetchUnits();

      expect(HttpClient.authGet).toHaveBeenCalledWith("/units?limit=100");
    });
  });
});
