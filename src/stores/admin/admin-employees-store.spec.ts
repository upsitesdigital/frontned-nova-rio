...
vi.mock("@/api/admin/admin-employees-api", () => ({
  AdminEmployeesApi: { fetchAdminEmployees: vi.fn() },
}));
...
describe("AdminEmployeesStore", () => {
  ...
  describe("loadEmployees", () => {
    ...
    it("should pass status filter when not 'all'", async () => {
      ...
      expect(AdminEmployeesApi.fetchAdminEmployees).toHaveBeenCalledWith(
    ...
    it("should set isAuthError on 401 error", async () => {
      ...
      vi.mocked(AdminEmployeesApi.fetchAdminEmployees).mockRejectedValue(authError);
  ...
  describe("setCurrentPage", () => {
    it("should update page and trigger load", async () => {
      ...
      expect(AdminEmployeesApi.fetchAdminEmployees).toHaveBeenCalled();
    });
  });
});
