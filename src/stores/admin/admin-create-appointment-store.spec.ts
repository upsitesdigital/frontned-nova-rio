...
const serviceOptionsUseCase = await import("@/use-cases/admin-services/get-admin-service-options");
...
describe("AdminCreateAppointmentStore", () => {
  ...
  describe("submitAppointment", () => {
    ...
    it("should pass form state to use case", async () => {
      ...
      expect(createUseCase.CreateAdminAppointment.submitAdminAppointment).toHaveBeenCalledWith({
        serviceId: "1",
        clientId: "2",
        employeeId: "3",
        duration: "60",
