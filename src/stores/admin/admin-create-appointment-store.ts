  ...
  loadOptions: async () => {
    ...
    try {
      const [clientsResult, servicesResult, employeesResult] = await Promise.allSettled([
        GetApprovedClientOptions.getApprovedClientOptions(),
        GetAdminServiceOptions.getAdminServiceOptions(),
...
export { useAdminCreateAppointmentStore, durationOptions, type AdminCreateAppointmentStore };
