...
describe("ProfileInfoStore", () => {
  ...
  describe("loadProfile", () => {
    ...
    it("should set error on failure", async () => {
      vi.mocked(ProfileApi.fetchClientProfile).mockRejectedValue(new Error("Network"));
    ...
    it("should set isLoading to true during API call", async () => {
      ...
      vi.mocked(ProfileApi.fetchClientProfile).mockReturnValue(
        new Promise((resolve) => {
  ...
  describe("saveProfile", () => {
    it("should save profile and show toast on success", async () => {
      ...
      vi.mocked(ProfileApi.updateClientProfile).mockResolvedValue(updatedProfile as never);
    ...
    it("should set error and return false on failure", async () => {
      vi.mocked(ProfileApi.updateClientProfile).mockRejectedValue(new Error("Save failed"));
    ...
    it("should pass edit fields to API", async () => {
      ...
      vi.mocked(ProfileApi.updateClientProfile).mockResolvedValue(mockProfile as never);

      await useProfileInfoStore.getState().saveProfile();

      expect(ProfileApi.updateClientProfile).toHaveBeenCalledWith({
        name: "Test",
        phone: "123",
        company: "Co",
        cpfCnpj: "456",
