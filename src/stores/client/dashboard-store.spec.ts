...
vi.mock("@/use-cases/client-dashboard/load-client-dashboard", () => ({ LoadClientDashboard: {
  loadClientDashboard: vi.fn(),
} }));

const { LoadClientDashboard } = await import("@/use-cases/client-dashboard/load-client-dashboard");
...
describe("DashboardStore", () => {
  ...
  describe("loadSummary", () => {
    it("should set summary on success", async () => {
      vi.mocked(LoadClientDashboard.loadClientDashboard).mockResolvedValue({
    ...
    it("should set isLoading to true before API call", async () => {
      ...
      vi.mocked(LoadClientDashboard.loadClientDashboard).mockReturnValue(
        new Promise((resolve) => {
