...
describe("RegistrationStore", () => {
  beforeEach(() => {
    ...
    vi.clearAllMocks();
    vi.mocked(SubmitRegistration.validateRegistrationInput).mockReturnValue({});
  });
  ...
  describe("submit", () => {
    it("should return false and set errors on validation failure", async () => {
      ...
      vi.mocked(SubmitRegistration.validateRegistrationInput).mockReturnValue(validationErrors);
      ...
      expect(SubmitRegistration.submitRegistration).not.toHaveBeenCalled();
    });

    it("should call SubmitRegistration.submitRegistration and return true on success", async () => {
      ...
      vi.mocked(SubmitRegistration.submitRegistration).mockResolvedValue({});
    ...
    it("should return false and set errors on API failure", async () => {
      ...
      vi.mocked(SubmitRegistration.submitRegistration).mockResolvedValue(apiErrors);
    ...
    it("should set isRegistering during API call", async () => {
      ...
      vi.mocked(SubmitRegistration.submitRegistration).mockReturnValue(
        new Promise((resolve) => {
