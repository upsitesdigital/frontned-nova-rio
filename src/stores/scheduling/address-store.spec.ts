...
describe("AddressStore", () => {
  ...
  describe("loadAddressByCep", () => {
    it("should load address on success", async () => {
      ...
      vi.mocked(ValidateAddress.validateAddress).mockResolvedValue({ address, error: null });
    ...
    it("should set cepError when address validation returns error", async () => {
      vi.mocked(ValidateAddress.validateAddress).mockResolvedValue({
        address: null,
    ...
    it("should set fallback error on exception", async () => {
      vi.mocked(ValidateAddress.validateAddress).mockRejectedValue(new Error("Network"));
    ...
    it("should set isLoadingAddress during API call", async () => {
      ...
      vi.mocked(ValidateAddress.validateAddress).mockReturnValue(
        new Promise((resolve) => {
